...
namespace FluentEvaluator.Actions
{
	...
	{
		public SingularAction(object objectToEvaluate, bool evaluationToPerform, bool continueEvaluations) : base(objectToEvaluate, evaluationToPerform, continueEvaluations)
		{
		}
